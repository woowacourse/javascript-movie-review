import { RATE_STAR_LENGTH, RATE_STAR_POINT_UNIT } from '../constant';
import { enterChangeStarState } from './events/handleChangeRateState';

export const createRateStars = (rate: number, status: boolean) => {
