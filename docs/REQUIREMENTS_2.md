...
- [x] 별점 매기기에서 똑같은 점수를 눌렀을 때 점수 취소 기능 구현
- [x] 별점에 마우스를 올렸을 때 별의 렌더를 바꾸어서 미리보기 기능 구현
- [x] 영화 제목이 2줄일 경우 별점의 위치 값이 일정하지 않은 이슈 해결
- [x] 사용자 경험을 위해 검색창에 value를 비우는 것이 아닌 남겨두도록 변경
- [x] E2E 테스트 코드 작성하기
