describe("2단계 - 영화 리뷰 테스트", () => {
  ...
  describe('모달 테스트', () => {
    it("지금 인기 있는 영화 리스트의 영화를 클릭하면 해당 영화 상세 정보 모달 창이 뜬다", () => {
      // 인기 영화 API 대기
    ...
    it("영화를 검색한 후 리스트에 있는 영화를 클릭하면 해당 영화 상세 정보 모달 창이 뜬다", () => {
    ...
    it("영화를 클릭한 후 모달에 있는 별을 클릭하면 문구가 추가된다", () => {
      cy.wait("@getPopularMoviesPage1");
    ...
    it("별점을 준 후 새로고침하고 다시 영화 클릭 시 저장된 별점을 볼 수 있다", () => {
      cy.wait("@getPopularMoviesPage1");
    ...
    it("지금 인기 있는 영화 리스트에서 스크롤을 리스트의 끝으로 내리면 영화 20개가 추가된다", () => {
      cy.wait("@getPopularMoviesPage1");
    ...
    it("영화를 검색한 후 리스트에서 스크롤을 리스트의 끝으로 내리면 영화 20개가 추가된다", () => {
      cy.get(".search-bar-input").type("짱구");
      cy.get(".search-bar-button").click();
    ...
    it("화면 너비를 1440px 이상으로 설정하면, 영화 리스트가 한 줄에 4개로 표시된다.", () => {
    ...
    it("화면 너비를 1024px 이상으로 설정하면, 영화 리스트가 한 줄에 3개로 표시된다.", () => {
    ...
    it("화면 너비를 768px 이상으로 설정하면, 영화 리스트가 한 줄에 4개로 표시된다.", () => {
      cy.viewport(768, 900);
      cy.wait("@getPopularMoviesPage1");
