...
// TODO: movie -> movieDetail로 변경해야함
const ModalInfoContainer = (movie: Movie) => {
...
const ModalSection = (movie: Movie) => {
...
const ModalContainer = (movie: Movie) => {
...
//TODO: id 값만 받아서 api 호출해서 데이터 받아오기
const DetailModal = (movie: Movie) => {
  ...
  $modal.appendChild(ModalContainer(movie));
