...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getPopularMovies\": () => (/* binding */ getPopularMovies),\n/* harmony export */   \"getSearchedMovies\": () => (/* binding */ getSearchedMovies)\n/* harmony export */ });\n/* harmony import */ var _constant_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/api */ \"./src/constant/api.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\nconst getPopularMovies = (page) => __awaiter(void 0, void 0, void 0, function* () {\n    const response = yield fetch(`${_constant_api__WEBPACK_IMPORTED_MODULE_0__.TMDB_BASE_URL}${_constant_api__WEBPACK_IMPORTED_MODULE_0__.API.GET_POPULAR}?api_key=${\"8234a3d5f8d4ad207c32e60e4aa9486b\"}&language=ko-KR&page=${page}`, {\n        method: \"GET\",\n    });\n    if (response.ok)\n        return response.json();\n    alert(\"오류 발생\");\n});\nconst getSearchedMovies = (movieName, page) => __awaiter(void 0, void 0, void 0, function* () {\n    const response = yield fetch(`${_constant_api__WEBPACK_IMPORTED_MODULE_0__.TMDB_BASE_URL}${_constant_api__WEBPACK_IMPORTED_MODULE_0__.API.SEARCH_MOVIES}?api_key=${\"8234a3d5f8d4ad207c32e60e4aa9486b\"}&language=ko-KR&query=${movieName}&page=${page}&include_adult=false`, {\n        method: \"GET\",\n    });\n    if (response.ok)\n        return response.json();\n    alert(\"오류 발생\");\n});\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/utils/fetch.ts?");
