...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar _MovieDataStateStore_fetchedMovieList, _MovieDataStateStore_totalMovieList, _MovieDataStateStore_isEndPage;\nclass MovieDataStateStore {\n    constructor() {\n        _MovieDataStateStore_fetchedMovieList.set(this, void 0);\n        _MovieDataStateStore_totalMovieList.set(this, void 0);\n        _MovieDataStateStore_isEndPage.set(this, true);\n    }\n    getTotalMovieData({ movieList, isEndPage }, resetMovieList) {\n        if (!__classPrivateFieldGet(this, _MovieDataStateStore_totalMovieList, \"f\") || resetMovieList)\n            __classPrivateFieldSet(this, _MovieDataStateStore_totalMovieList, movieList, \"f\");\n        else\n            __classPrivateFieldSet(this, _MovieDataStateStore_totalMovieList, __classPrivateFieldGet(this, _MovieDataStateStore_totalMovieList, \"f\").concat(movieList), \"f\");\n        __classPrivateFieldSet(this, _MovieDataStateStore_isEndPage, isEndPage, \"f\");\n    }\n    addMovieData({ movieList, isEndPage }, resetMovieList) {\n        __classPrivateFieldSet(this, _MovieDataStateStore_fetchedMovieList, movieList, \"f\");\n        if (!__classPrivateFieldGet(this, _MovieDataStateStore_totalMovieList, \"f\") || resetMovieList) {\n            __classPrivateFieldSet(this, _MovieDataStateStore_totalMovieList, movieList, \"f\");\n            return;\n        }\n        __classPrivateFieldSet(this, _MovieDataStateStore_totalMovieList, __classPrivateFieldGet(this, _MovieDataStateStore_totalMovieList, \"f\").concat(movieList), \"f\");\n        __classPrivateFieldSet(this, _MovieDataStateStore_isEndPage, isEndPage, \"f\");\n    }\n    get fetchedMovieData() {\n        return {\n            movieList: __classPrivateFieldGet(this, _MovieDataStateStore_fetchedMovieList, \"f\"),\n            isEndPage: __classPrivateFieldGet(this, _MovieDataStateStore_isEndPage, \"f\"),\n        };\n    }\n    get totalMovieData() {\n        return {\n            movieList: JSON.parse(JSON.stringify(__classPrivateFieldGet(this, _MovieDataStateStore_totalMovieList, \"f\"))),\n            isEndPage: __classPrivateFieldGet(this, _MovieDataStateStore_isEndPage, \"f\"),\n        };\n    }\n}\n_MovieDataStateStore_fetchedMovieList = new WeakMap(), _MovieDataStateStore_totalMovieList = new WeakMap(), _MovieDataStateStore_isEndPage = new WeakMap();\nconst movieDataStateStore = new MovieDataStateStore();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (movieDataStateStore);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/model/MovieDataStateStore.ts?");
